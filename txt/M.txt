...
public class MainControl {
	...
	public static void menu() {
		...
		int choice = JOptionPane.showOptionDialog(null, "          學生選課系統", "期末作品",
				JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.INFORMATION_MESSAGE, t("ntoulogo.gif",35), a, 0);
		switch(choice) {
		case 1://管理員登入
	...
	public static ImageIcon t(String s,int x) {
		  ImageIcon p = new ImageIcon(s);
		  Image old = p.getImage(); // transform it 
		  Image newing = old.getScaledInstance(x, x,Image.SCALE_SMOOTH); // scale it the smooth way  
		  ImageIcon pp = new ImageIcon(newing);
		  return pp;
		 }
}
